...
class Video {
    constructor(
      ...
      public cId: number,
      public url: string,
      public owner: UpUser | null = null,
      public twoLevel?: PartitionType,
      public oneLevel?: PartitionType
    ) {}
  }
  
  function createVideo(data:any): Video {
    return new Video(
      data.aid,
      data.title,
      data.pic,
      ...
      data.tid ? new PartitionType(data.tid, data.tname) : undefined,
      data.reid ? new PartitionType(data.reid, data.toptype) : undefined
    );
  }
  
  function createVideoByDetail(data:any): Video {
    return new Video(
      data.aid,
      data.title,
      data.pic,
  ...
  function createVideoByLatest(data:any): Video {
    return new Video(
      data.aid,
      data.title,
      data.pic,
  ...
  function createVideoByUser(data:any): Video {
    return new Video(
      data.aid,
      data.title,
      data.pic,
  ...
  function createVideoBySearch(data:any): Video {
